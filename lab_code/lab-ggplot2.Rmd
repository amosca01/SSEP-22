...
#. Let's return to p4. Since a home price index of 1 is an important benchmark, it is worth highlighting as contextual reference in our plot. Use `geom_vline()` to add a dotted, black, vertical line to p4.
