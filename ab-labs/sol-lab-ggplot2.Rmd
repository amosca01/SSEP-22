...
# sample solution
    home_plot + 
      ...
      scale_color_gradient2(breaks = c(1975.25, 1994.25, 2013.25),
                        ...
                        midpoint = 1994.25)
```
#. Recall that layers in <code>ggplot2</code> are added sequentially. How would you put the dotted vertical line you created in the previous exercise **behind** the data values?
